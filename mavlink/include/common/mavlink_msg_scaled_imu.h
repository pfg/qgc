...
typedef struct __mavlink_scaled_imu_t 
{
	...
	int16_t xmag; ///< X Magnetic field (micro tesla)
	int16_t ymag; ///< Y Magnetic field (micro tesla)
	int16_t zmag; ///< Z Magnetic field (micro tesla)
 ...
 * @param xmag X Magnetic field (micro tesla)
 * @param ymag Y Magnetic field (micro tesla)
 * @param zmag Z Magnetic field (micro tesla)
...
static inline uint16_t mavlink_msg_scaled_imu_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint64_t usec, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag)
{
	...
	p->xmag = xmag; // int16_t:X Magnetic field (micro tesla)
	p->ymag = ymag; // int16_t:Y Magnetic field (micro tesla)
	p->zmag = zmag; // int16_t:Z Magnetic field (micro tesla)
 ...
 *
 * @return X Magnetic field (micro tesla)
 */
 ...
 *
 * @return Y Magnetic field (micro tesla)
 */
 ...
 *
 * @return Z Magnetic field (micro tesla)
 */
