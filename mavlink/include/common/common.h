 ...
 *	 Generated on Thursday, April 21 2011, 20:44 UTC
 */
#ifndef COMMON_H
#define COMMON_H
...
enum MAV_CMD
{
	...
	MAV_CMD_NAV_ORIENTATION_TARGET=80, /* Set the location the system should be heading towards (camera heads or rotary wing aircraft). | Empty | Empty | Empty | Empty | Latitude | Longitude | Altitude | */
