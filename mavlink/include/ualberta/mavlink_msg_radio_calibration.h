...
#define MAVLINK_MSG_ID_RADIO_CALIBRATION_LEN 84
#define MAVLINK_MSG_222_LEN 84
...
static inline uint16_t mavlink_msg_radio_calibration_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const float* aileron, const float* elevator, const float* rudder, const float* gyro, const float* pitch, const float* throttle)
{
	...
	memcpy(p->aileron, aileron, sizeof(p->aileron)); // float[3]:Aileron setpoints: high, center, low
	memcpy(p->elevator, elevator, sizeof(p->elevator)); // float[3]:Elevator setpoints: high, center, low
	memcpy(p->rudder, rudder, sizeof(p->rudder)); // float[3]:Rudder setpoints: high, center, low
	memcpy(p->gyro, gyro, sizeof(p->gyro)); // float[2]:Tail gyro mode/gain setpoints: heading hold, rate mode
	memcpy(p->pitch, pitch, sizeof(p->pitch)); // float[5]:Pitch curve setpoints (every 25%)
	memcpy(p->throttle, throttle, sizeof(p->throttle)); // float[5]:Throttle curve setpoints (every 25%)
 ...
 */
static inline uint16_t mavlink_msg_radio_calibration_get_aileron(const mavlink_message_t* msg, float* aileron)
{
	mavlink_radio_calibration_t *p = (mavlink_radio_calibration_t *)&msg->payload[0];
 ...
 */
static inline uint16_t mavlink_msg_radio_calibration_get_elevator(const mavlink_message_t* msg, float* elevator)
{
	mavlink_radio_calibration_t *p = (mavlink_radio_calibration_t *)&msg->payload[0];
 ...
 */
static inline uint16_t mavlink_msg_radio_calibration_get_rudder(const mavlink_message_t* msg, float* rudder)
{
	mavlink_radio_calibration_t *p = (mavlink_radio_calibration_t *)&msg->payload[0];
 ...
 */
static inline uint16_t mavlink_msg_radio_calibration_get_gyro(const mavlink_message_t* msg, float* gyro)
{
	mavlink_radio_calibration_t *p = (mavlink_radio_calibration_t *)&msg->payload[0];
 ...
 */
static inline uint16_t mavlink_msg_radio_calibration_get_pitch(const mavlink_message_t* msg, float* pitch)
{
	mavlink_radio_calibration_t *p = (mavlink_radio_calibration_t *)&msg->payload[0];
 ...
 */
static inline uint16_t mavlink_msg_radio_calibration_get_throttle(const mavlink_message_t* msg, float* throttle)
{
	mavlink_radio_calibration_t *p = (mavlink_radio_calibration_t *)&msg->payload[0];
