...
#define MAVLINK_MSG_ID_ACTION 19
#define MAVLINK_MSG_ID_ACTION_LEN 3
#define MAVLINK_MSG_19_LEN 3
 ...
 */
static inline uint16_t mavlink_msg_action_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t target_system, uint8_t target_component, uint8_t action)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_action_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint8_t target_system, uint8_t target_component, uint8_t action)
{
	mavlink_action_t *p = (mavlink_action_t *)&msg->payload[0];
	msg->msgid = MAVLINK_MSG_ID_ACTION;
...
{
	return mavlink_msg_action_pack(system_id, component_id, msg, action->target_system, action->target_component, action->action);
}
...
static inline void mavlink_msg_action_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t action)
{
...
/**
 * @brief Get field target_system from action message
 *
 * @return The system executing the action
 */
static inline uint8_t mavlink_msg_action_get_target_system(const mavlink_message_t* msg)
{
	mavlink_action_t *p = (mavlink_action_t *)&msg->payload[0];
