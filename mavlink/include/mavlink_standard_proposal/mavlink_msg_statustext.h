 ...
 */
static inline uint16_t mavlink_msg_statustext_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const int8_t* text, uint8_t severity)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_statustext_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const int8_t* text, uint8_t severity)
{
	mavlink_statustext_t *p = (mavlink_statustext_t *)&msg->payload[0];
	msg->msgid = MAVLINK_MSG_ID_STATUSTEXT;
...
{
	return mavlink_msg_statustext_pack(system_id, component_id, msg, statustext->text, statustext->severity);
}
...
static inline void mavlink_msg_statustext_send(mavlink_channel_t chan, const int8_t* text, uint8_t severity)
{
