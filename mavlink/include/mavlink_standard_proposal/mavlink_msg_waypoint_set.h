...
#define MAVLINK_MSG_ID_WAYPOINT_SET_LEN 28
#define MAVLINK_MSG_16_LEN 28
 ...
 */
static inline uint16_t mavlink_msg_waypoint_set_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t target_system, uint8_t target_component, uint16_t wp_id, float param1, float param2, uint8 orbit, uint8_t current, float x, float y, float z, uint8_t type, uint8_t autocontinue)
{
	mavlink_waypoint_set_t *p = (mavlink_waypoint_set_t *)&msg->payload[0];
	...
	return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_SET_LEN);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_waypoint_set_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint8_t target_system, uint8_t target_component, uint16_t wp_id, float param1, float param2, uint8 orbit, uint8_t current, float x, float y, float z, uint8_t type, uint8_t autocontinue)
{
	mavlink_waypoint_set_t *p = (mavlink_waypoint_set_t *)&msg->payload[0];
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_SET;
	...
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_SET_LEN);
}
...
{
	return mavlink_msg_waypoint_set_pack(system_id, component_id, msg, waypoint_set->target_system, waypoint_set->target_component, waypoint_set->wp_id, waypoint_set->param1, waypoint_set->param2, waypoint_set->orbit, waypoint_set->current, waypoint_set->x, waypoint_set->y, waypoint_set->z, waypoint_set->type, waypoint_set->autocontinue);
}
...
static inline void mavlink_msg_waypoint_set_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t wp_id, float param1, float param2, uint8 orbit, uint8_t current, float x, float y, float z, uint8_t type, uint8_t autocontinue)
{
	...
	msg.STX = MAVLINK_STX;
	msg.len = MAVLINK_MSG_ID_WAYPOINT_SET_LEN;
	msg.msgid = MAVLINK_MSG_ID_WAYPOINT_SET;
...
static inline void mavlink_msg_waypoint_set_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t wp_id, float param1, float param2, uint8 orbit, uint8_t current, float x, float y, float z, uint8_t type, uint8_t autocontinue)
{
	...
	mavlink_waypoint_set_t payload;
	uint16_t checksum;
	mavlink_waypoint_set_t *p = &payload;
	...
	hdr.STX = MAVLINK_STX;
	hdr.len = MAVLINK_MSG_ID_WAYPOINT_SET_LEN;
	hdr.msgid = MAVLINK_MSG_ID_WAYPOINT_SET;
 ...
 * @return Waypoint ID
 */
static inline uint16_t mavlink_msg_waypoint_set_get_wp_id(const mavlink_message_t* msg)
{
	mavlink_waypoint_set_t *p = (mavlink_waypoint_set_t *)&msg->payload[0];
 ...
 */
static inline float mavlink_msg_waypoint_set_get_param1(const mavlink_message_t* msg)
{
	mavlink_waypoint_set_t *p = (mavlink_waypoint_set_t *)&msg->payload[0];
 ...
 */
static inline float mavlink_msg_waypoint_set_get_param2(const mavlink_message_t* msg)
{
	mavlink_waypoint_set_t *p = (mavlink_waypoint_set_t *)&msg->payload[0];
 ...
 */
static inline uint8 mavlink_msg_waypoint_set_get_orbit(const mavlink_message_t* msg)
{
	mavlink_waypoint_set_t *p = (mavlink_waypoint_set_t *)&msg->payload[0];
 ...
 */
static inline uint8_t mavlink_msg_waypoint_set_get_autocontinue(const mavlink_message_t* msg)
{
	mavlink_waypoint_set_t *p = (mavlink_waypoint_set_t *)&msg->payload[0];
...
{
	memcpy( waypoint_set, msg->payload, sizeof(mavlink_waypoint_set_t));
}
