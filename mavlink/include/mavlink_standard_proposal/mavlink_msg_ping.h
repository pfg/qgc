 ...
 */
static inline uint16_t mavlink_msg_ping_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint32_t seq, uint8_t target_system, uint8_t target_component, uint64_t time, uint32_t version)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_ping_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint32_t seq, uint8_t target_system, uint8_t target_component, uint64_t time, uint32_t version)
{
	mavlink_ping_t *p = (mavlink_ping_t *)&msg->payload[0];
	msg->msgid = MAVLINK_MSG_ID_PING;
...
static inline void mavlink_msg_ping_send(mavlink_channel_t chan, uint32_t seq, uint8_t target_system, uint8_t target_component, uint64_t time, uint32_t version)
{
 ...
 */
static inline uint32_t mavlink_msg_ping_get_version(const mavlink_message_t* msg)
{
	mavlink_ping_t *p = (mavlink_ping_t *)&msg->payload[0];
